<template>
    <div id="__next">
        ...
        <div class="relative flex w-full flex-col mt-16">
                            ...
                            <div class="mx-auto max-w-2xl lg:max-w-5xl">
                                <div class="max-w-2xl">
                                    ...
                                    <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur incidunt nostrum neque nesciunt. Nobis nulla neque nisi modi a iste impedit quia possimus rerum repellendus, quo fuga voluptates ipsam totam.
                                    </p>
                                            ...
                                            <h2
                                                ...
                                                <div
                                                    ...
                                                    href="/articles/crafting-a-design-system-for-a-multiplanetary-future"><span
                                                        ...
                                                        class="relative z-10">Process 1</span></a>
                                            </h2>
                                            <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nulla amet eveniet saepe iste laboriosam enim fugiat velit id! Quasi obcaecati blanditiis quam maiores hic ea voluptates similique dolorum nisi aperiam?
                                            </p>
                                        </article>
                                        <article class="group relative flex flex-col items-start">
                                            <h2
                                        ...
                                        <div class="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
                                            <h2 class="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100"><svg
                                                    ...
                                                    <path
                                                        ...
                                                        class="stroke-zinc-400 dark:stroke-zinc-500"></path>
                                                </svg><span class="ml-3">Resent Work</span></h2>
                                            <ol class="mt-6 space-y-4">
                                                <li class="flex gap-4">
                                                    ...
                                                    <dl class="flex flex-auto flex-wrap gap-x-2">
                                                        ...
                                                        <dd class="text-xs text-zinc-500 dark:text-zinc-400">Date</dd>
                                                    </dl>
                                                </li>
                                                <li class="flex gap-4">
                                                    <div
